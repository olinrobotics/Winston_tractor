...
int gettimeofday(struct timeval *tv, struct timezone *tz)
{
  ...
  static const uint64_t DELTA_EPOCH_IN_MICROSECS = 11644473600000000ULL;
...
namespace hidi
{
  ...
  {
    static const long int offset = 315964800; // difference between Jan 6 1980 and Jan 1 1979
    static const double mega = 1000000.0;
    timeval tv;
    double time;
    gettimeofday(&tv, NULL);
    time = static_cast<double>(tv.tv_sec-offset)+static_cast<double>(tv.tv_usec)/mega;
    return (time);
  }
}
