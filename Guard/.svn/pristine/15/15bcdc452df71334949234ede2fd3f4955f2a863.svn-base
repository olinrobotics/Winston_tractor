classdef ARDVision < Msg.App & Msg.Log 
  ...
  methods (Access = public)
    function this = ARDVision()
      ...
      this.stateTopic = Msg.Proto.topic('nav.RelFusedState', cfg.ownID);
          ...
          if(abs(time-this.relState.getTimeS())<(2.0*this.cfg.imgPeriod))
            ...
            switch(this.visionAlgorithm)
              case 'ContourHomography'
                % TODO: resolve camera measurement into body frame
              ...
              otherwise % RedBall
                ...
                % resolve measurement into body frame
                T(1) = T(1)+this.cfg.cameraForwardM;
