...
namespace math
{
  ...
  public:
    ...
    static void axisToEuler(const double& v0, const double& v1, const double& v2, double& y0, double& y1, double& y2)
    {
      ...
      math::Rotation::axisToMatrix(v0, v1, v2, r00, r10, r20, r01, r11, r21, r02, r12, r22);
      math::Rotation::matrixToEuler(r00, r10, r20, r01, r11, r21, r02, r12, r22, y0, y1, y2);
      return;
    }
    static inline void axisToEuler(const double (&v)[3], double& y0, double& y1, double& y2)
    {
      math::Rotation::axisToEuler(v[0], v[1], v[2], y0, y1, y2);
      return;
    }
    static inline void axisToEuler(const double& v0, const double& v1, const double& v2, double (&y)[3])
    {
      math::Rotation::axisToEuler(v0, v1, v2, y[0], y[1], y[2]);
      return;
    }
    static inline void axisToEuler(const double (&v)[3], double (&y)[3])
    {
      math::Rotation::axisToEuler(v[0], v[1], v[2], y[0], y[1], y[2]);
      return;
    }
     ...
     */
    static void axisToMatrix(const double& v0, const double& v1, const double& v2, double& r00, double& r10, 
    ...
    {
      math::Rotation::axisToMatrix(v[0], v[1], v[2], r00, r10, r20, r01, r11, r21, r02, r12, r22);
      return;
    }
    static inline void axisToMatrix(const double& v0, const double& v1, const double& v2, double (&r)[3][3])
    {
      math::Rotation::axisToMatrix(v0, v1, v2, r[0][0], r[1][0], r[2][0], r[0][1], r[1][1], r[2][1], r[0][2], r[1][2], 
        r[2][2]);
      return;
    }
    static inline void axisToMatrix(const double (&v)[3], double (&r)[3][3])
    {
      math::Rotation::axisToMatrix(v[0], v[1], v[2], r[0][0], r[1][0], r[2][0], r[0][1], r[1][1], r[2][1], r[0][2], 
        r[1][2], r[2][2]);
      return;
    }
    ...
    {
      double q0, q1, q2, q3;
      math::Rotation::eulerToQuat(y0, y1, y2, q0, q1, q2, q3);
      math::Rotation::quatToAxis(q0, q1, q2, q3, v0, v1, v2);
      return;
    }
    static inline void eulerToAxis(const double (&y)[3], double& v0, double& v1, double& v2)
    {
      math::Rotation::eulerToAxis(y[0], y[1], y[2], v0, v1, v2);
      return;
    }
    static inline void eulerToAxis(const double& y0, const double& y1, const double& y2, double (&v)[3])
    {
      math::Rotation::eulerToAxis(y0, y1, y2, v[0], v[1], v[2]);
      return;
    }
    static inline void eulerToAxis(const double (&y)[3], double (&v)[3])
    {
      math::Rotation::eulerToAxis(y[0], y[1], y[2], v[0], v[1], v[2]);
      return;
    }
     ...
     */
    static void eulerToMatrix(const double& y0, const double& y1, const double& y2, double& r00, double& r10, 
      double& r20, double& r01, double& r11, double& r21, double& r02, double& r12, double& r22)
    {
      double c0 = cos(y0);
      double c1 = cos(y1);
    ...
    static inline void eulerToMatrix(const double (&y)[3], double& r00, double& r10, double& r20, double& r01, 
      double& r11, double& r21, double& r02, double& r12, double& r22)
    {
      math::Rotation::eulerToMatrix(y[0], y[1], y[2], r00, r10, r20, r01, r11, r21, r02, r12, r22);
      return;
    }
    static inline void eulerToMatrix(const double& y0, const double& y1, const double& y2, double (&r)[3][3])
    {
      math::Rotation::eulerToMatrix(y0, y1, y2, r[0][0], r[1][0], r[2][0], r[0][1], r[1][1], r[2][1], r[0][2], r[1][2], 
        r[2][2]);
      return;
    }
    static inline void eulerToMatrix(const double (&y)[3], double (&r)[3][3])
    {
      math::Rotation::eulerToMatrix(y[0], y[1], y[2], r[0][0], r[1][0], r[2][0], r[0][1], r[1][1], r[2][1], r[0][2], 
        r[1][2], r[2][2]);
      return;
    }
    ...
    {
      math::Rotation::eulerToQuat(y[0], y[1], y[2], q0, q1, q2, q3);
      return;
    }
    static inline void eulerToQuat(const double& y0, const double& y1, const double& y2, double (&q)[4])
    {
      math::Rotation::eulerToQuat(y0, y1, y2, q[0], q[1], q[2], q[3]);
      return;
    }
    static inline void eulerToQuat(const double (&y)[3], double (&q)[4])
    {
      math::Rotation::eulerToQuat(y[0], y[1], y[2], q[0], q[1], q[2], q[3]);
      return;
    }
     ...
     */
    static void matrixToAxis(const double& r00, const double& r10, const double& r20, const double& r01, 
      const double& r11, const double& r21, const double& r02, const double& r12, const double& r22, double& v0, 
      double& v1, double& v2)
    {
      double q0, q1, q2, q3;
      math::Rotation::matrixToQuat(r00, r10, r20, r01, r11, r21, r02, r12, r22, q0, q1, q2, q3);
      math::Rotation::quatToAxis(q0, q1, q2, q3, v0, v1, v2);
      return;
    }
    static inline void matrixToAxis(const double (&r)[3][3], double& v0, double& v1, double& v2)
    {
      math::Rotation::matrixToAxis(r[0][0], r[1][0], r[2][0], r[0][1], r[1][1], r[2][1], r[0][2], r[1][2], r[2][2], 
        v0, v1, v2);
      return;
    }
    ...
    {
      math::Rotation::matrixToAxis(r00, r10, r20, r01, r11, r21, r02, r12, r22, v[0], v[1], v[2]);
      return;
    }
     ...
     */
    static void matrixToEuler(const double& r00, const double& r10, const double& r20, const double& r01, 
      const double& r11, const double& r21, const double& r02, const double& r12, const double& r22, double& y0, 
      double& y1, double& y2)
    {
      y0 = atan2(r21, r22);
      y1 = asin(-r20);
    ...
    {
      math::Rotation::matrixToEuler(r[0][0], r[1][0], r[2][0], r[0][1], r[1][1], r[2][1], r[0][2], r[1][2], r[2][2], 
        y0, y1, y2);
      return;
    }
    ...
    {
      math::Rotation::matrixToEuler(r00, r10, r20, r01, r11, r21, r02, r12, r22, y[0], y[1], y[2]);
      return;
    }
     ...
     */
    static void matrixToQuat(const double& r00, const double& r10, const double& r20, const double& r01, 
      const double& r11, const double& r21, const double& r02, const double& r12, const double& r22, double& q0, 
    ...
    {
      math::Rotation::matrixToQuat(r[0][0], r[1][0], r[2][0], r[0][1], r[1][1], r[2][1], r[0][2], r[1][2], r[2][2], q0, 
        q1, q2, q3);
      return;
    }
    ...
    {
      math::Rotation::matrixToQuat(r00, r10, r20, r01, r11, r21, r02, r12, r22, q[0], q[1], q[2], q[3]);
      return;
    }
    static inline void matrixToQuat(const double (&r)[3][3], double (&q)[4])
    {
      math::Rotation::matrixToQuat(r[0][0], r[1][0], r[2][0], r[0][1], r[1][1], r[2][1], r[0][2], r[1][2], r[2][2], 
        q[0], q[1], q[2], q[3]);
      return;
    }
     ...
     */
    static void quatToAxis(const double& q0, const double& q1, const double& q2, const double& q3, double& v0, 
      double& v1, double& v2)
    {
      double qNorm0, qNorm1, qNorm2, qNorm3;
      double n;
      double theta;
      math::Rotation::quatNorm(q0, q1, q2, q3, qNorm0, qNorm1, qNorm2, qNorm3);
     ...
     */
    static void quatToEuler(const double& q0, const double& q1, const double& q2, const double& q3, double& y0, 
      double& y1, double& y2)
    {
      double qNorm0, qNorm1, qNorm2, qNorm3;
    ...
    {
      math::Rotation::quatToEuler(q[0], q[1], q[2], q[3], y0, y1, y2);
      return;
    }
    static inline void quatToEuler(const double& q0, const double& q1, const double& q2, const double& q3, 
      double (&y)[3])
    {
      math::Rotation::quatToEuler(q0, q1, q2, q3, y[0], y[1], y[2]);
      return;
    }
    static inline void quatToEuler(const double (&q)[4], double (&y)[3])
    {
      math::Rotation::quatToEuler(q[0], q[1], q[2], q[3], y[0], y[1], y[2]);
      return;
    }
     ...
     */
    static void quatToMatrix(const double& q0, const double& q1, const double& q2, const double& q3, double& r00, 
      double& r10, double& r20, double& r01, double& r11, double& r21, double& r02, double& r12, double& r22)
    {
      double qNorm0, qNorm1, qNorm2, qNorm3;
      double q00, q11, q22, q33, q01, q12, q23, q03, q02, q13;
      math::Rotation::quatNorm(q0, q1, q2, q3, qNorm0, qNorm1, qNorm2, qNorm3);
    ...
    static inline void quatToMatrix(const double (&q)[4], double& r00, double& r10, double& r20, double& r01, 
      double& r11, double& r21, double& r02, double& r12, double& r22)
    {
      math::Rotation::quatToMatrix(q[0], q[1], q[2], q[3], r00, r10, r20, r01, r11, r21, r02, r12, r22);
      return;
    }
    static inline void quatToMatrix(const double& q0, const double& q1, const double& q2, const double& q3, 
      double (&r)[3][3])
    {
      math::Rotation::quatToMatrix(q0, q1, q2, q3, r[0][0], r[1][0], r[2][0], r[0][1], r[1][1], r[2][1], r[0][2], 
        r[1][2], r[2][2]);
      return;
    }
    static inline void quatToMatrix(const double (&q)[4], double (&r)[3][3])
    {
      math::Rotation::quatToMatrix(q[0], q[1], q[2], q[3], r[0][0], r[1][0], r[2][0], r[0][1], r[1][1], r[2][1], 
        r[0][2], r[1][2], r[2][2]);
      return;
    }
    ...
    {
      math::Rotation::quatToHomo(q[0], q[1], q[2], q[3], h);
      return;
    }
    ...
    {
      math::Rotation::homoToQuat(h, q[0], q[1], q[2], q[3]);
      return;
    }
    ...
    {
      math::Rotation::quatNorm(q[0], q[1], q[2], q[3], qNorm0, qNorm1, qNorm2, qNorm3);
      return;
    }
    static inline void quatNorm(const double& q0, const double& q1, const double& q2, const double& q3, 
      double (&qNorm)[4])
    {
      math::Rotation::quatNorm(q0, q1, q2, q3, qNorm[0], qNorm[1], qNorm[2], qNorm[3]);
      return;
    }
    static inline void quatNorm(const double (&q)[4], double (&qNorm)[4])
    {
      math::Rotation::quatNorm(q[0], q[1], q[2], q[3], qNorm[0], qNorm[1], qNorm[2], qNorm[3]);
      return;
    }
     ...
     */
    static void quatInv(const double& q0, const double& q1, const double& q2, const double& q3, double& qInv0, 
      double& qInv1, double& qInv2, double& qInv3)
    {
      qInv0 = q0;
      qInv1 = -q1;
      qInv2 = -q2;
    ...
    {
      math::Rotation::quatInv(q[0], q[1], q[2], q[3], qInv0, qInv1, qInv2, qInv3);
      return;
    }
    static inline void quatInv(const double& q0, const double& q1, const double& q2, const double& q3, 
      double (&qInv)[4])
    {
      math::Rotation::quatInv(q0, q1, q2, q3, qInv[0], qInv[1], qInv[2], qInv[3]);
      return;
    }
    static inline void quatInv(const double (&q)[4], double (&qInv)[4])
    {
      math::Rotation::quatInv(q[0], q[1], q[2], q[3], qInv[0], qInv[1], qInv[2], qInv[3]);
      return;
    }
    ...
    static inline void quatMult(const double (&a)[4], const double (&b)[4], double& c0, double& c1, double& c2, 
      double& c3)
    {
      math::Rotation::quatMult(a[0], a[1], a[2], a[3], b[0], b[1], b[2], b[3], c0, c1, c2, c3);
      return;
    }
    ...
    {
      math::Rotation::quatMult(a0, a1, a2, a3, b0, b1, b2, b3, c[0], c[1], c[2], c[3]);
      return;
    }
    static inline void quatMult(const double (&a)[4], const double (&b)[4], double (&c)[4])
    {
      math::Rotation::quatMult(a[0], a[1], a[2], a[3], b[0], b[1], b[2], b[3], c[0], c[1], c[2], c[3]);
      return;
    }
